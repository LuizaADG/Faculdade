...
/*
* Grupo: Camilla Damascenos, Lucas Coelho , Luiza Ávila
Função mais custosa: compute_path
      Tempo Sequencial:
                      First Compute Path Time = 0.172416
                      Second Compute Path Time = 0.589636
                      Work hard time = 0.763532
      ...
      Tempo paralelo:
                      ...
                      First Compute Path Time = 0.071672    SpeedUp= 2,4
                      Second Compute Path Time = 0.297822   SpeedUp= 1,98
                      Work hard time = 0.370686             SpeedUp= 2,06

                      real  0m0.535s                        SpeedUp= 1,79
                      user  0m0.866s                        SpeedUp= 1,01
                      sys 0m0.040s                          SpeedUp= 2,00
    Tempo paralelo com schedule(static):
                      First Compute Path Time = 0.073190    SpeedUp= 2,35
                      Second Compute Path Time = 0.292369   SpeedUp= 1,98
                      Work hard time = 0.367432             SpeedUp= 2,07

                      real  0m0.531s                        SpeedUp= 1,80
                      user  0m0.818s                        SpeedUp= 1,07
                      sys 0m0.080s                          SpeedUp= Não teve
    Tempo paralelo com shedule(guided):
                      First Compute Path Time = 0.074067    SpeedUp= 2,32
                      Second Compute Path Time = 0.298968   SpeedUp= 1,97
                      Work hard time = 0.374454             SpeedUp= 2,04

                      real  0m0.538s                        SpeedUp= 1,78
                      user  0m0.856s                        SpeedUp= 1,02
                      sys 0m0.057s                          SpeedUp= 

    Tempo paralelo com schedule(dynamic):
                    First Compute Path Time = 0.136459      SpeedUp= 1,26
                    Second Compute Path Time = 0.564643     SpeedUp= 1,04
                    Work hard time = 0.702524               SpeedUp= 1,08

                    real  0m0.862s                          SpeedUp= 1,11
                    user  0m1.485s                          SpeedUp= Não teve
                    sys 0m0.080s                            SpeedUp= Não teve
    Tempo paralelo com 3 funções paralelizadas (apply_discount,compute_cost,compute_path):
                    First Compute Path Time = 0.076202      SpeedUp= 2,26
                    Second Compute Path Time = 0.309351     SpeedUp= 1,90
                    Work hard time = 0.386995               SpeedUp= 1,97

                    real  0m0.551s                          SpeedUp= 1,73
                    user  0m0.878s                          SpeedUp= Não teve
                    sys 0m0.060s                            SpeedUp= 1,33
Explicação dos tempos medidos:
                  Podemos notar, que não houve uma grande diferença do tempo paralelo com 3 funções paralelizadas
                  em relação ao tempo em paralelo apenas no compute_path, e o motivo disso é pela função compute_path
                  ser mais custosa, tendo um impacto maior no tempo de execução.
                  Um possível motivo pro schedule(dynamic) não ter um resultado muito bom, seria por causa do overhead
                  ser maior, tendo um maior tempo de execução.
